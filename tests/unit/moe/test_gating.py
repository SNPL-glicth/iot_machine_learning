...
from infrastructure.ml.moe.gating.base import GatingProbs, ContextVector
...
class TestGatingErrors:
    ...
    def test_missing_regime(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            ContextVector(regime="", domain="iot", n_points=10, signal_features={})
        
        assert "regime cannot be empty" in str(exc_info.value)
