...
pytest.importorskip("xgboost", reason="xgboost is required for TreeGatingNetwork tests")

from domain.model.context_vector import ContextVector
from infrastructure.ml.moe.gating.tree_gating import TreeGatingNetwork, TreeRoutingExplanation
