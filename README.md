...
* **$\lambda_t \in [0, 1]$**: Factor bayesiano de incertidumbre y exploración. Si $\lambda_t \to 1$, el sistema exige coherencia rítmica estricta o fuerza abstención (**`HOLD`**).
* **Veto Estocástico**: Si un experto crítico discrepa o Mahalanobis detecta cambio de régimen, Rosa Roja suspende la acción para prevenir falsos positivos.

---

## 📁 Estructura del Proyecto

* **`domain/`**: Entidades puras y modelos de dominio (series temporales, ventanas, anomalías). Aislado de infraestructura.
...
* **`infrastructure/adapters/`**: Adaptadores de entrada y salida (sensores, telemetría WebSocket).
