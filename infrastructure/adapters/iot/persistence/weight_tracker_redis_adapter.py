"""Redis adapter for Bayesian weight tracker — isolated Redis operations.

Fail-safe Redis operations with scope-aware keys and tenant isolation.
"""
...
class WeightTrackerRedisClient:
    ...
    def _get_redis_key(self, regime: str) -> str:
        ...
        if self._scope is not None:
            ...
            return self._scope.with_regime(regime).storage_key
