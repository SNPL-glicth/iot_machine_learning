...
class EngineReliabilityTracker:
    ...
    def __init__(
        ...
        *,
        ...
        self._memory: "OrderedDict[Tuple[str, str], Tuple[float, float]]" = OrderedDict()
    ...
    def _load(self, series_id: str, engine_name: str) -> Tuple[float, float]:
        ...
        with self._lock:
            return self._memory.get(
                (series_id, engine_name), (self._alpha0, self._beta0)
            )
    ...
    def _save(
        ...
        if self._redis is not None:
            try:
                ...
                pipe.hset(key, mapping={"alpha": alpha, "beta": beta})
