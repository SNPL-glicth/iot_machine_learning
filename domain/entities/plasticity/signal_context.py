...
class SignalContext:
    ...
    def context_key(self) -> str:
        ...
        Examples:
            >>> ctx = SignalContext(regime=RegimeType.STABLE, noise_ratio=0.1,
    ...
    @classmethod
    def create_default(cls, regime: RegimeType = RegimeType.UNKNOWN) -> SignalContext:
        ...
        Returns:
            SignalContext with default values
        """
        now = datetime.now()
        return cls(
            regime=regime,
